  ...
  return (
    <div>
          ...
          {DAMAGE_TYPES.map((t) => (
            <button
              ...
              style={{
                ...
                color: activeType === t.id ? "white" : "#475569",
                borderColor: t.color,
              }}
            >
              <span
      ...
      <svg
        viewBox="0 0 320 160"
        onClick={handleClick}
        className={`w-full rounded-lg bg-paper ring-1 ring-slate-200 ${
          !readOnly ? "cursor-crosshair" : ""
        }`}
      >
        <rect x="60" y="35" width="200" height="90" rx="35" fill="none" stroke="#94a3b8" strokeWidth="2" />
        <path d="M215 45 L245 55 L245 105 L215 115 Z" fill="none" stroke="#cbd5e1" strokeWidth="1.5" />
        <path d="M105 45 L75 55 L75 105 L105 115 Z" fill="none" stroke="#cbd5e1" strokeWidth="1.5" />
        <rect x="85" y="20" width="26" height="10" rx="4" fill="#cbd5e1" />
        <rect x="85" y="130" width="26" height="10" rx="4" fill="#cbd5e1" />
        <rect x="205" y="20" width="26" height="10" rx="4" fill="#cbd5e1" />
        <rect x="205" y="130" width="26" height="10" rx="4" fill="#cbd5e1" />
        <text x="262" y="85" fontSize="10" fill="#94a3b8">ÖN</text>
        <text x="58" y="85" fontSize="10" fill="#94a3b8" textAnchor="end">ARXA</text>
