...
export default function CarCard({ car, activeRental, onCycleStatus }) {
  return (
    <div className="rounded-xl2 bg-white ring-1 ring-stone-100 shadow-soft p-4 flex items-center justify-between gap-3">
      ...
      <div className="flex flex-col items-end gap-2 shrink-0">
        ...
        {car.status !== "icarədə" && (
          <button
            ...
            className="inline-flex items-center gap-1 text-[11.5px] text-stone-400 hover:text-stone-600 transition-colors"
          >
            <Wrench size={12} />
